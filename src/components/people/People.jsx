       ...
       return (
         ...
         <Header/>
              ...
              <div className="ItemHeader">
                <div className="desc">
                  <h2>People</h2>
                  <span>Real people, captured. Photography has the power to reflect the world around</span>
                  <span>us, give voice to individuals and groups within our communities — and most</span>
                  <span>importantly — tell their story.</span>
                </div>
                <div className="title">
